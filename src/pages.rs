...
fn add_custom_next_button(ui: &mut egui::Ui, text: impl Into<egui::WidgetText>, enabled: bool) -> egui::Response {
  egui_alignments::Row::new(egui::Align::BOTTOM)
      .show(ui, |ui| -> egui::Response {
          ...
          let button_color =
              egui::Color32::from_hex(if enabled { "#71CC98" } else { "#A0A0A0" }).expect("Failed to parse color from hex.");
